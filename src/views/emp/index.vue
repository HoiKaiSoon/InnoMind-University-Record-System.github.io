  ...
  <div class="app-container">
    ...
    <el-form :inline="true" :model="searchEmp" class="demo-form-inline">
      ...
      <el-form-item label="Gender">
        <el-select v-model="searchEmp.gender" placeholder="Please choose">
    ...
    <el-row>
      ...
      <el-button type="primary" size="medium" @click="dialogVisible = true; emp = { image: ''};">+ Add New Employee</el-button>
    </el-row>

    <!--添加数据对话框表单-->
    <el-dialog ref="form" title="Add New Employee" :visible.sync="dialogVisible" width="30%">
      <el-form ref="form" :model="emp" label-width="80px" size="mini">
        <el-form-item label="Username">
          <el-input v-model="emp.username" placeholder="Please enter username" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Employee Name">
          <el-input v-model="emp.name" placeholder="Please enter employee name" autocomplete="off" />
        </el-form-item>

        <el-form-item label="Gender">
          <el-select v-model="emp.gender" placeholder="Please choose" style="width:100%">
            <el-option
        ...
        <el-form-item label="Position">
          <el-select v-model="emp.job" placeholder="Please choose" value-key="emp.job" style="width:100%">
            <el-option
        ...
        <el-form-item label="Dept">
          <el-select v-model="emp.deptId" placeholder="Please choose" style="width:100%">
            <!--
    ...
    <template>
      <el-table :data="tableData" style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="Employee Name" align="center" />
        ...
        <el-table-column align="center" label="Position">
          <template slot-scope="scope">
            <span v-if="scope.row.job == 1" style="margin-right: 10px">Course Leader</span>
            <span v-if="scope.row.job == 2" style="margin-right: 10px">Lecturer</span>
            <span v-if="scope.row.job == 3" style="margin-right: 10px">Department manager</span>
            <span v-if="scope.row.job == 4" style="margin-right: 10px">Director</span>
            <span v-if="scope.row.job == 5" style="margin-right: 10px">Administration</span>
            <span v-if="scope.row.job == 6" style="margin-right: 10px">Counselor</span>
          </template>
        </el-table-column>
